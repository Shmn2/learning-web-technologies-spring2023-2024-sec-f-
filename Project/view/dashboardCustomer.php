...
<div style="background-color: white; padding: 10px;">
  ...
  <a href="searchEventC.php" style="color: black; text-decoration: none; font-weight: bold;">Search</a>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <a href="purchaseTicket.php" style="color: black; text-decoration: none; font-weight: bold;">Purchase Ticket</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="agenda.php" style="color: black; text-decoration: none; font-weight: bold;">Create New Agenda</a>&nbsp;&nbsp;&nbsp;&nbsp;

  <!-- Notification Dropdown -->
  <details style="display: inline-block;">
    <summary style="font-weight: bold;">Notifications</summary>
    <div style="background-color: gray; min-width: 200px; padding: 10px;">
      <a href="eventNotice.php" style="color: black; text-decoration: none; font-weight: bold; display: block;">Event Notice</a>
      <a href="paymentNotice.php" style="color: black; text-decoration: none; font-weight: bold; display: block;">Transactions</a>
      <!-- <a href="#" style="color: black; text-decoration: none; font-weight: bold; display: block;">VIDEO</a> -->
    </div>
  </details> 
</div>
